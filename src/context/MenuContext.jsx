...
//   // Load user data and fetch cart data if token is available
//   useEffect(() => {
...
//   // Add item to cart (non-async version, used if needed)
...
//           // Clear local storage only after server response
...
//   // Load data on initial render and when token changes
//   useEffect(() => {
//     if (token) {
