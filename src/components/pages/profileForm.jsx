...
//     // Close the profile form after updating
//     onClose();
//   } catch (error) {
//     console.error('Failed to update profile:', error);
//   }
...
// // In the render method, update the image source
// <img 
//   src={typeof profileData.image === 'string' ? profileData.image : `${url}/uploads/${profileData.image}`} 
//   alt="Profile" 
//   className="w-24 h-24 object-cover rounded-full border-2 border-gray-300"
// />
...
// the starting page of the last page
...
//   if (selectedImage) {
//     formData.append('image', selectedImage); // Ensure the file is being sent
//   }

//   try {
//     await updateUserProfile(formData); // This should update the context as well
//     await getUserProfile(); // Ensure the profile is refetched
...
//     try {
//       await updateUserProfile(formData);
//       await fetchProfile(); // Refetch the profile after updating
